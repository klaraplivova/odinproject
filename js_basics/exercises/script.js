...
let str5 =
  "For the moment I'm going to bed because it's late/nand I wish you a good night and good luck/nwith a handshake."; // the same can be achieved using /n
...
if (1 || 0) {
  // treated as true || false -> outputs "Hi"
  console.log("Hi");
}
...
if (hour < 10 || hour > 18 || isWeekend) {
  // it is the weekend - only one expression has to return true
...
if (age < 14 || age > 19) {
} // one expression must return true

let userName = prompt("Who's there?");

if (userName === "Admin") {
  // only one = would always be true
...
let answer = prompt("What is the official JS name?");
...
let promptedNumber = prompt("Type in a number", 0); // the 0 creates a default string
